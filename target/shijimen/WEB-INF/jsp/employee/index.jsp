...
<body class="hold-transition skin-blue sidebar-mini" style="overflow:hidden;">
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            <a href="javascript:void (0)" class="logo">
               <img src="<%=path %>/static/image/employee/bslogo2.png" />
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="hidden-xs">${sessionScope.employeeName}[${sessionScope.employeeNum}]</span>
                            </a>
        ...
        <div id="content-wrapper" class="content-wrapper">
            <div class="content-tabs">
                ...
                <nav class="page-tabs menuTabs">
                    <div class="page-tabs-content" style="margin-left: 0px;">
                        <a href="javascript:;" class="menuTab active" data-id="reception-reservation">前台预约</a>
                    </div>
                </nav>
            ...
            <div class="content-iframe" >
                <div class="mainContent" id="content-main" style="margin: 10px; margin-bottom: 0; padding: 0;">
                    <iframe id="myFrame" class="LRADMS_iframe" width="100%" height="100%" src="reception-reservation" frameborder="0" data-id="reception-reservation"></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="<%=path %>/static/js/employee/eindex.js"></script>
    <script>
        $(function(){
            setColor();
        });
