        ...
        <div class="notice_check">
              <p>
                  ...
                  <select id="state-select" class="find_input" style="width:60px;" required>
			            ...
			            <option data-name="finish" data-value="1">已生效</option>
		          ...
		          <select id="time-select" class="find_input" style="width:80px;" required>
		           ...
		           <input type="text" id="datetimepicker1" class="find_input" style="width:100px;" placeholder="起始时间" autocomplete="off">-
		           <input type="text" id="datetimepicker2" class="find_input" style="width:100px;" placeholder="终止时间" autocomplete="off">
		           <button id="search-btn" class="check_btn search-btn">查询</button>
		           <button id="detail-view-btn" class="btn btn-primary btn-sm" style="float:right;">展开</button>
              </p> 
        </div>
        <div id="toolbar">
        </div>
...
<script src="<%=path %>/static/js/employee/orderManage.js"></script>
<script>
