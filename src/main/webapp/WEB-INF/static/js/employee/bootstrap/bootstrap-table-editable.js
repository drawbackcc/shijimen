...
/*原来的column.formatter begin*/
	        ...
	        /*原来的column.formatter end*/
	        
	        /*改写的的column.formatter begin*/
	        /*
	        column.formatter = function(value, row, index) {
	        	...
	        	    var _dont_edit_formatter = false;
	        	    if (column.editable.hasOwnProperty('noeditFormatter')) {
	        		console.log("column.editable.hasOwnProperty('noeditFormatter')");
	        	...
	        	      '>' + process.value + '</a>'
	        	     ].join('');
	        	     console.log(_dont_edit_formatter);
	        	    }//if (column.editable.hasOwnProperty('noeditFormatter')) 
	        	    if (_dont_edit_formatter === false) {
	        		console.log("_dont_edit_formatter = false");
	        	...
	        	     ].join('');
	        	    } else {
	        		console.log("_dont_edit_formatter = true");
	        	     return _dont_edit_formatter;
	        	    }
	        	   };
	        	*/
	        /*改写的的column.formatter end*/
